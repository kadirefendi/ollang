<template>
  <svg
    ...
    y="0px"
    viewBox="0 0 512 512"
    style="enable-background: new 0 0 512 512; max-width: 75%"
    xml:space="preserve"
  >
    <path
      style="fill: #fcd063"
      d="M456,32h-64V16c0-8.84-7.16-16-16-16H136c-8.84,0-16,7.16-16,16v16H56c-8.84,0-16,7.16-16,16v96l0,0
    ...
    <path
      style="fill: #82a7c4"
      d="M152,480h208c4.416,0,8,3.584,8,8v16c0,4.416-3.584,8-8,8H152c-4.416,0-8-3.584-8-8v-16
	C144,483.584,147.584,480,152,480z"
    />
    <path
      style="fill: #c9d5e3"
      d="M352,432c0-8.84-7.16-16-16-16H176c-8.84,0-16,7.16-16,16v48h192V432z"
    />
    <path
      style="fill: #f6b545"
      d="M120,200v-8c-5.456-0.016-10.864-0.968-16-2.8c-0.032,6.184-5.064,11.176-11.256,11.144
    ...
    <g>
      <path
        style="fill: #f6b545"
        d="M424,48L424,48c-8.84,0-16-7.16-16-16h-16v32h48C440,55.16,432.84,48,424,48z"
      />
      <path
        style="fill: #f6b545"
        d="M88,48L88,48c8.84,0,16-7.16,16-16h16v32H72C72,55.16,79.16,48,88,48z"
      />
      <path
        style="fill: #f6b545"
    ...
    <g>
      <path
        style="fill: #ffe27a"
        d="M136,0h240l0,0l0,0c0,8.84-7.16,16-16,16H152C143.16,16,136,8.84,136,0L136,0L136,0z"
      />
      <path
        style="fill: #ffe27a"
        d="M159.12,148.4c-7.912,3.936-17.52,0.704-21.448-7.208c-1.096-2.208-1.672-4.648-1.672-7.112V48
		c0-8.84-7.16-16-16-16v168L392,64V32L159.12,148.4z"
      />
      <path
        style="fill: #ffe27a"
        d="M136,264l256-128V80L120.96,215.52C122.864,232.488,127.968,248.936,136,264z"
      />
    </g>
    <path
      style="fill: #e78825"
      d="M297.68,216c-0.592-0.064-1.168-0.256-1.68-0.56l-40-21.84l-40,21.84
    ...
    <g>
      <polygon
        style="fill: #f19920"
        points="232.16,116.72 218.4,118.8 187.84,134.08 208.88,155.52 284.96,117.52 279.84,116.72 
		268.96,93.52 235.12,110.48 	"
      />
      <path
        style="fill: #f19920"
        d="M209.84,210.48c-0.32,1.752,0.36,3.544,1.76,4.64c1.432,0.936,3.288,0.936,4.72,0l40-21.84
    ...
    <path
      style="fill: #f6b545"
      d="M464,136c-4.416,0-8,3.584-8,8c-0.04,22.464-11.848,43.264-31.12,54.8
